...
def train_data(bs):
    ...
    train_ds = ImageZoomDataset(train_dataset_rootdir, get_transform(train=True))
    print(train_ds)
...
def test_data(bs):
    ...
    test_ds = ImageZoomDataset(test_dataset_rootdir, get_transform(train=False))
...
def ImageZoomDatasetTest():
    ...
    ds = ImageZoomDataset(train_dataset_rootdir)
    print(ds)
    # src, tgt = ds[10]
